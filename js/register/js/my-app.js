...
$$('#submmit-login').on('click', function () {
    ...
    var query = 'http://127.0.0.1:8000/api/auth/login?email='+username+'&password='+password; 
    myApp.showIndicator();
...
$$('#submmit-register').on('click', function () {
    ...
    var query = 'http://127.0.0.1:8000/api/auth/sign-up?name='+username+'&email='+email+'&password='+password+'&password_confirmation='+password2;
    var postdata = {};
